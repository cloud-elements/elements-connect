        ...
        .controller('TreeNodeController', ['$scope', '$element', '$attrs', 'treeConfig',
            function ($scope, $element, $attrs, treeConfig) {
                ...
                $scope.toggle = function() {
                    ...
                    //Ramana callback event when the objects are expanded
                    $scope.$callbacks.toggle($scope, $scope.collapsed);
                };
            ...
            function(treeConfig, $window) {
                return {
                    ...
                    link: function(scope, element, attrs) {
                        ...
                        //Ramana Hiding the add of empty tree class
...
//                        }
                        ...
                        callbacks.toggle = function(event, eventAction) {
            ...
            function (treeConfig, $uiTreeHelper, $window, $document, $timeout) {
                return {
                    ...
                    link: function(scope, element, attrs, controllersArr) {
                        ...
                        var startPos, firstMoving, dragInfo, pos, tmpTargetNode;
...
//                             placeElm.addClass('angular-ui-tree-placeholder-2');
                        ...
                        var dragMove = function(e) {
                            ...
                            if (dragElm) {
                                ...
                                //TODO Ramana Commented out the gestures from moving from left to right
                                // move horizontal
...
//                                }
                                ...
                                if (!pos.dirAx) {
                                    ...
                                    //TODO Ramana
                                    // 1) Changed the logic to accept the node when drop at the end so, droping at the end becomes easy
                                    // 2) Removing the logic of adding the drop target above or below the node when identified.
                                    //   2.1 Adding logic to always make it has a child when the parent node is found
...
//                                    }
                                    ...
                                    if(!targetNode.$parentNodesScope && !targetNode.$childNodesScope && isEmpty == false) {
                                        isEmpty = true;
                                    }

                                    // if placeholder move from empty tree, reset it.
                                    if (treeScope && placeElm.parent() != undefined && treeScope.$element && placeElm.parent()[0] != treeScope.$element[0]) {
                                    ...
                                    if (isEmpty) { // it's an empty tree
                                        ...
                                        if(tmpTargetNode != null && tmpTargetNode != undefined && tmpTargetNode.$element != null
                                            && tmpTargetNode.$element.removeClass != null) {
                                            tmpTargetNode.$element.removeClass('angular-ui-tree-placeholder-mapping-hover-object');
                                            tmpTargetNode.$element.removeClass('angular-ui-tree-placeholder-mapping-hover');
                                        }

                                        tmpTargetNode = targetNode;
                                        if (targetNode.$nodesScope && targetNode.$nodesScope.accept(scope, 0)) {
				                            placeElm.removeClass('angular-ui-tree-placeholder-2');
                				            placeElm.removeClass('angular-ui-tree-placeholder');				                            
                				            placeElm.addClass('angular-ui-tree-placeholder');
                                            targetNode.place(placeElm);
                                            var cNodes = targetNode.$nodesScope.childNodes();
                                            if(cNodes)
                                                dragInfo.moveTo(targetNode.$nodesScope, cNodes, cNodes.length);
                                            else
                                                dragInfo.moveTo(targetNode.$nodesScope, cNodes, 0);
                                        }
                                    } else if (targetNode.dragEnabled()){ // drag enabled
                                        //Ramana  - Commenting all these to always drop as a child
...
//                                        }
                                        ...
                                        if (targetBefore && targetNode.accept(scope, targetNode.childNodesCount())) {
                                            ...
                                            //Adding logic to add CSS to the parent Node also holding the parentNode in tmp variable
                                            tmpTargetNode = targetNode;

                                            targetElm = targetNode.$element;
                                            var targetModelValue =targetNode.$modelValue;

                                            if(targetModelValue != null && targetModelValue != undefined
                                                && (targetModelValue.type == 'object' || targetModelValue.type == 'Object' || targetModelValue.type == 'array')
                                            ){
                                                targetElm.addClass('angular-ui-tree-placeholder-mapping-hover-object');
                                            }
                                            else {
                                                targetElm.addClass('angular-ui-tree-placeholder-mapping-hover');
                                            }
                                            placeElm.removeClass('angular-ui-tree-placeholder');
											placeElm.removeClass('angular-ui-tree-placeholder-2');
				                            placeElm.addClass('angular-ui-tree-placeholder-2');
